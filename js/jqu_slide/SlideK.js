...
var SlideK =function(){
	...
	this.rotationNext = function (delay=300,callback){
		return rotationNext(delay=300,callback)
	}
	...
	this.rotationPrev = function (delay=300,callback){
		rotationPrev(delay=300,callback)
