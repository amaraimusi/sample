...
var UploadFileValidation =function(){
	 ...
	 */
	this.check = function(e,permitExts,permitMimes,allowEmpty=false){
	 ...
	 */
	this.checkImage = function(e,allowEmpty=false){
	 ...
	 * @return エラー情報。 正常である場合はnullを返す
	 */
	this.checkFileObject = function(oFile,permitExts,permitMimes,allowEmpty=false){
