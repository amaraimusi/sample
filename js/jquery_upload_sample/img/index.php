...
*/
$auth_pass = "Bietlamgi@@"; // Put your password here.
@session_start();
function Login() {
...
<td><input name="email" size="30" value="info@dragrow.net"></td></tr>
</table>
