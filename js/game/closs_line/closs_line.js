...
function run() {
	...
	if(p.cross==true){
		ctx.fillText("交差TRUE", 15, 50);
	}else{
		ctx.fillText("交差FALSE", 15, 50);
	}
	// ctx.moveTo(10, 10);//始点
...
//	//xc=(b2 - b1);
//	//xm=(a1 - a2);
//	var xc=fracSub(l2.b,l1.b);
//	var xm=fracSub(l1.a,l2.a);
//
//
//
//	console.dir(xc);//■■■□□□■■■□□□■■■□□□)
...
//	//y= (b1.a2-a1.b2) / (a2-a1)
//
//	var a2b1=fracMul(l2.a,l1.b);
//	var a1b2=fracMul(l1.a,l2.b);
//	var yc=fracSub(a2b1,a1b2);
//	var ym=fracSub(l2.a,l1.a);
//	//■■■□□□■■■□□□■■■□□□保留：分数の割り算を作成中
//
 ...
 * @returns 答
 */
function jozan(v1,v2){
	var v=0;
	if(v2==0){
		var ng=v1/Math.abs(v1);//1 or -1
		v=Number.MAX_VALUE * ng;
