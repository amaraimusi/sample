...
<div class="container">
	...
	<form action="sample4_submit.php" method="post">
		<div id="toolbar" style="display:none;width:500px">
			<div class="btn-group">
				...
				<a class="btn btn-primary btn-sm" title="プレビュー" onclick="wh5_preview()"><span class="glyphicon glyphicon-transfer"></span></a>
			</div><!--btn-group -->
		  ...
		  <textarea id="textarea" name="textarea1" placeholder="文章を書いてください" style="width:500px;height:300px">


		  </textarea>
		  <div id="preview" style="display:none;width:500px;height:300px"></div>
