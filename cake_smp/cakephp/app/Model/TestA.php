...
class TestA extends Model {
	...
	function saveTestAData(){
		Debugger::dump('デバッグsaveTestAData');//■■■□□□■■■□□□■■■□□□
		Debugger::log('デバッグsaveTestAData');//■■■□□□■■■□□□■■■□□□
...
//        	Debugger::dump('デバッグgetTestAList');//■■■□□□■■■□□□■■■□□□
//         Debugger::log($query);//■■■□□□■■■□□□■■■□□□
