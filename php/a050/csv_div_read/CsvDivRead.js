...
class CsvDivRead{
	 ...
	 *  - csv_read_ajax_url CSV読込AjaxURL
	...
	_setParamIfEmpty(param){
		...
		if(param['batch_data_num'] == null) param['batch_data_num'] = 3; // ■■■□□□■■■□□□■■■□□□あとで1000にする
	...
	<div>
		...
		<div id="sdr_zip_send_w" >
			<input id="sdr_fuk_upload_btn" type="button" value="ZIPを送信" class="btn btn-success">
	...
	threadCsvRead(res){
		...
		if(param.end_flg == true){
			this.succMsg.html('CSV読込処理は、すべて終了しました。');
